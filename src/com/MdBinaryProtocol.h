...
class MdBinaryProtocol : public QObject {
...
signals:
    ...
    //! signal that an complete frame was received
    void frameReceived();
...
public slots:
    ...
    void openPort();
    void closePort();
    bool changePortSettings (QString sport, QString speed);
