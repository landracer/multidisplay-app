...
template <> constexpr inline auto Plot::qt_create_metaobjectdata<qt_meta_tag_ZN4PlotE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        // Slot 'setTransformation'
        QtMocHelpers::SlotData<void(QwtTransform *)>(1, 2, QMC::AccessPublic, QMetaType::Void, {{
            { 0x80000000 | 3, 2 },
        }}),
    };
...
void Plot::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->setTransformation((*reinterpret_cast<std::add_pointer_t<QwtTransform*>>(_a[1]))); break;
        default: ;
        }
    }
}
