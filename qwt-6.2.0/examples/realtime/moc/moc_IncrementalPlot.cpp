...
namespace {
struct qt_meta_tag_ZN15IncrementalPlotE_t {};
} // unnamed namespace

template <> constexpr inline auto IncrementalPlot::qt_create_metaobjectdata<qt_meta_tag_ZN15IncrementalPlotE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<IncrementalPlot, qt_meta_tag_ZN15IncrementalPlotE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject IncrementalPlot::staticMetaObject = { {
    QMetaObject::SuperData::link<QwtPlot::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN15IncrementalPlotE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN15IncrementalPlotE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN15IncrementalPlotE_t>.metaTypes,
    nullptr
} };
...
void *IncrementalPlot::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN15IncrementalPlotE_t>.strings))
