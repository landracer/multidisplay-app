...
namespace {
struct qt_meta_tag_ZN6TVPlotE_t {};
} // unnamed namespace

template <> constexpr inline auto TVPlot::qt_create_metaobjectdata<qt_meta_tag_ZN6TVPlotE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<TVPlot, qt_meta_tag_ZN6TVPlotE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject TVPlot::staticMetaObject = { {
    QMetaObject::SuperData::link<QwtPlot::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN6TVPlotE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN6TVPlotE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN6TVPlotE_t>.metaTypes,
    nullptr
} };
...
void *TVPlot::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN6TVPlotE_t>.strings))
