...
namespace {
struct qt_meta_tag_ZN12AmplifierBoxE_t {};
} // unnamed namespace

template <> constexpr inline auto AmplifierBox::qt_create_metaobjectdata<qt_meta_tag_ZN12AmplifierBoxE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<AmplifierBox, qt_meta_tag_ZN12AmplifierBoxE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject AmplifierBox::staticMetaObject = { {
    QMetaObject::SuperData::link<QFrame::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN12AmplifierBoxE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN12AmplifierBoxE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN12AmplifierBoxE_t>.metaTypes,
    nullptr
} };
...
void *AmplifierBox::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN12AmplifierBoxE_t>.strings))
