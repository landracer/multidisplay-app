...
namespace {
struct qt_meta_tag_ZN16QwtPlotMagnifierE_t {};
} // unnamed namespace

template <> constexpr inline auto QwtPlotMagnifier::qt_create_metaobjectdata<qt_meta_tag_ZN16QwtPlotMagnifierE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<QwtPlotMagnifier, qt_meta_tag_ZN16QwtPlotMagnifierE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject QwtPlotMagnifier::staticMetaObject = { {
    QMetaObject::SuperData::link<QwtMagnifier::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN16QwtPlotMagnifierE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN16QwtPlotMagnifierE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN16QwtPlotMagnifierE_t>.metaTypes,
    nullptr
} };
...
void *QwtPlotMagnifier::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN16QwtPlotMagnifierE_t>.strings))
