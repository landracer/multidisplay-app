...
namespace {
struct qt_meta_tag_ZN13QwtPlotPannerE_t {};
} // unnamed namespace

template <> constexpr inline auto QwtPlotPanner::qt_create_metaobjectdata<qt_meta_tag_ZN13QwtPlotPannerE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<QwtPlotPanner, qt_meta_tag_ZN13QwtPlotPannerE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject QwtPlotPanner::staticMetaObject = { {
    QMetaObject::SuperData::link<QwtPanner::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN13QwtPlotPannerE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN13QwtPlotPannerE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN13QwtPlotPannerE_t>.metaTypes,
    nullptr
} };
...
void *QwtPlotPanner::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN13QwtPlotPannerE_t>.strings))
