...
namespace {
struct qt_meta_tag_ZN17QwtPolarMagnifierE_t {};
} // unnamed namespace

template <> constexpr inline auto QwtPolarMagnifier::qt_create_metaobjectdata<qt_meta_tag_ZN17QwtPolarMagnifierE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<QwtPolarMagnifier, qt_meta_tag_ZN17QwtPolarMagnifierE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject QwtPolarMagnifier::staticMetaObject = { {
    QMetaObject::SuperData::link<QwtMagnifier::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN17QwtPolarMagnifierE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN17QwtPolarMagnifierE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN17QwtPolarMagnifierE_t>.metaTypes,
    nullptr
} };
...
void *QwtPolarMagnifier::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN17QwtPolarMagnifierE_t>.strings))
